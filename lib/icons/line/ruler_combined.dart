...
// Generated in 2024-08-26T20:40:00.157313

import 'dart:math' as math;

import 'package:flutter/material.dart';

class RulerCombinedIcon extends StatelessWidget {
  final Color? color;

  const RulerCombinedIcon({
    super.key,
    this.color,
  });
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: RulerCombinedPainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class RulerCombinedPainter extends CustomPainter {
  final Color color;

  const RulerCombinedPainter({
    super.repaint,
    required this.color,
  });
