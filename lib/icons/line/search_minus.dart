...
// Generated in 2024-08-26T20:40:00.254687

import 'dart:math' as math;

import 'package:flutter/material.dart';

class SearchMinusIcon extends StatelessWidget {
  final Color? color;
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: SearchMinusPainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class SearchMinusPainter extends CustomPainter {
  final Color color;

  const SearchMinusPainter({
    super.repaint,
    required this.color,
  });
