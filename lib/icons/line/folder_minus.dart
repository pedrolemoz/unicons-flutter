...
// Generated in 2024-08-26T20:39:58.234924

import 'dart:math' as math;

import 'package:flutter/material.dart';

class FolderMinusIcon extends StatelessWidget {
  final Color? color;
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: FolderMinusPainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class FolderMinusPainter extends CustomPainter {
  final Color color;

  const FolderMinusPainter({
    super.repaint,
    required this.color,
  });
