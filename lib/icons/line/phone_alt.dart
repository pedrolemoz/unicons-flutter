...
// Generated in 2024-08-26T20:39:59.760698

import 'dart:math' as math;

import 'package:flutter/material.dart';

class PhoneAltIcon extends StatelessWidget {
  final Color? color;
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: PhoneAltPainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class PhoneAltPainter extends CustomPainter {
  final Color color;

  const PhoneAltPainter({
    super.repaint,
    required this.color,
  });
