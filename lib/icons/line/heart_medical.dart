...
// Generated in 2024-08-26T20:39:58.500825

import 'dart:math' as math;

import 'package:flutter/material.dart';

class HeartMedicalIcon extends StatelessWidget {
  final Color? color;

  const HeartMedicalIcon({
    super.key,
    this.color,
  });
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: HeartMedicalPainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class HeartMedicalPainter extends CustomPainter {
  final Color color;

  const HeartMedicalPainter({
    super.repaint,
    required this.color,
  });
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.cubicTo(
      14.413017408514172 * scale + translationX,
      4.818091699608452 * scale + translationY,
      17.086983267512423 * scale + translationX,
      4.818091699608452 * scale + translationY,
    ...
    path.cubicTo(
      20.39427243811712 * scale + translationX,
      8.129835476478663 * scale + translationY,
      20.394272438117124 * scale + translationX,
      10.8101645470206 * scale + translationY,
      18.750000023263524 * scale + translationX,
      12.480000015484201 * scale + translationY,
    );
