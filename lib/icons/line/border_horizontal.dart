...
// Generated in 2024-08-26T20:39:56.147319

import 'dart:math' as math;

import 'package:flutter/material.dart';

class BorderHorizontalIcon extends StatelessWidget {
  final Color? color;
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: BorderHorizontalPainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class BorderHorizontalPainter extends CustomPainter {
  final Color color;

  const BorderHorizontalPainter({
    super.repaint,
    required this.color,
  });
