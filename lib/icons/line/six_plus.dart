...
// Generated in 2024-08-26T20:39:55.430253

import 'dart:math' as math;

import 'package:flutter/material.dart';

class SixPlusIcon extends StatelessWidget {
  final Color? color;
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: SixPlusPainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class SixPlusPainter extends CustomPainter {
  final Color color;

  const SixPlusPainter({
    super.repaint,
    required this.color,
  });
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.cubicTo(
      15.500000511314102 * scale + translationX,
