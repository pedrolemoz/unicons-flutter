...
// Generated in 2024-08-26T20:40:01.211646

import 'dart:math' as math;

import 'package:flutter/material.dart';

class UnlockAltIcon extends StatelessWidget {
  final Color? color;
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: UnlockAltPainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class UnlockAltPainter extends CustomPainter {
  final Color color;

  const UnlockAltPainter({
    super.repaint,
    required this.color,
  });
