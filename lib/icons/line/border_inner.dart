...
// Generated in 2024-08-26T20:39:56.152306

import 'dart:math' as math;

import 'package:flutter/material.dart';

class BorderInnerIcon extends StatelessWidget {
  final Color? color;

  const BorderInnerIcon({
    super.key,
    this.color,
  });
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: BorderInnerPainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class BorderInnerPainter extends CustomPainter {
  final Color color;

  const BorderInnerPainter({
    super.repaint,
    required this.color,
  });
