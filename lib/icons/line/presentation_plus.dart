...
// Generated in 2024-08-26T20:39:59.935652

import 'dart:math' as math;

import 'package:flutter/material.dart';

class PresentationPlusIcon extends StatelessWidget {
  final Color? color;

  const PresentationPlusIcon({
    super.key,
    this.color,
  });
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: PresentationPlusPainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class PresentationPlusPainter extends CustomPainter {
  final Color color;

  const PresentationPlusPainter({
    super.repaint,
    required this.color,
  });
