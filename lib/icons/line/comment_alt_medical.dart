...
// Generated in 2024-08-26T20:39:56.952566

import 'dart:math' as math;

import 'package:flutter/material.dart';

class CommentAltMedicalIcon extends StatelessWidget {
  final Color? color;

  const CommentAltMedicalIcon({
    super.key,
    this.color,
  });
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: CommentAltMedicalPainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class CommentAltMedicalPainter extends CustomPainter {
  final Color color;

  const CommentAltMedicalPainter({
    super.repaint,
    required this.color,
  });
