...
// Generated in 2024-08-26T20:39:57.048232

import 'dart:math' as math;

import 'package:flutter/material.dart';

class CommentExclamationIcon extends StatelessWidget {
  final Color? color;

  const CommentExclamationIcon({
    super.key,
    this.color,
  });
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: CommentExclamationPainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class CommentExclamationPainter extends CustomPainter {
  final Color color;
