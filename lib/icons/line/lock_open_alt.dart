...
// Generated in 2024-08-26T20:39:59.156457

import 'dart:math' as math;

import 'package:flutter/material.dart';

class LockOpenAltIcon extends StatelessWidget {
  final Color? color;

  const LockOpenAltIcon({
    super.key,
    this.color,
  });
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: LockOpenAltPainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class LockOpenAltPainter extends CustomPainter {
  final Color color;

  const LockOpenAltPainter({
    super.repaint,
    required this.color,
  });
