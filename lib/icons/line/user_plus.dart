...
// Generated in 2024-08-26T20:40:01.284577
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: UserPlusPainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class UserPlusPainter extends CustomPainter {
  final Color color;

  const UserPlusPainter({
    super.repaint,
    required this.color,
  });
