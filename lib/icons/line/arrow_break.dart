...
// Generated in 2024-08-26T20:39:55.685737

import 'dart:math' as math;

import 'package:flutter/material.dart';

class ArrowBreakIcon extends StatelessWidget {
  final Color? color;

  const ArrowBreakIcon({
    super.key,
    this.color,
  });
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: ArrowBreakPainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class ArrowBreakPainter extends CustomPainter {
  final Color color;

  const ArrowBreakPainter({
    super.repaint,
    required this.color,
  });
