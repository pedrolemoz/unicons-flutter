...
// Generated in 2024-08-26T20:39:59.925678

import 'dart:math' as math;

import 'package:flutter/material.dart';

class PresentationMinusIcon extends StatelessWidget {
  final Color? color;

  const PresentationMinusIcon({
    super.key,
    this.color,
  });
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: PresentationMinusPainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class PresentationMinusPainter extends CustomPainter {
  final Color color;

  const PresentationMinusPainter({
    super.repaint,
    required this.color,
  });
