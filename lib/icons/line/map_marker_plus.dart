...
// Generated in 2024-08-26T20:39:59.215975

import 'dart:math' as math;

import 'package:flutter/material.dart';

class MapMarkerPlusIcon extends StatelessWidget {
  final Color? color;

  const MapMarkerPlusIcon({
    super.key,
    this.color,
  });
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: MapMarkerPlusPainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class MapMarkerPlusPainter extends CustomPainter {
  final Color color;

  const MapMarkerPlusPainter({
    super.repaint,
    required this.color,
  });
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.cubicTo(
      13.0 * scale + translationX,
      7.897715250169206 * scale + translationY,
    ...
    path.cubicTo(
      11.0 * scale + translationX,
      13.002284749830793 * scale + translationY,
      11.447715250169207 * scale + translationX,
