...
// Generated in 2024-08-26T20:39:55.496582

import 'dart:math' as math;

import 'package:flutter/material.dart';

class AlignCenterJustifyIcon extends StatelessWidget {
  final Color? color;

  const AlignCenterJustifyIcon({
    super.key,
    this.color,
  });
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: AlignCenterJustifyPainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class AlignCenterJustifyPainter extends CustomPainter {
  final Color color;
