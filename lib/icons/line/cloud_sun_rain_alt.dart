...
// Generated in 2024-08-26T20:39:56.798355

import 'dart:math' as math;

import 'package:flutter/material.dart';

class CloudSunRainAltIcon extends StatelessWidget {
  final Color? color;

  const CloudSunRainAltIcon({
    super.key,
    this.color,
  });
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: CloudSunRainAltPainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class CloudSunRainAltPainter extends CustomPainter {
  final Color color;

  const CloudSunRainAltPainter({
    super.repaint,
    required this.color,
  });
