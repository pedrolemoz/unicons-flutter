...
// Generated in 2024-08-26T20:39:57.421305

import 'dart:math' as math;

import 'package:flutter/material.dart';

class DiceOneIcon extends StatelessWidget {
  final Color? color;
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: DiceOnePainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class DiceOnePainter extends CustomPainter {
  final Color color;
