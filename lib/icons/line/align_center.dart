...
// Generated in 2024-08-26T20:39:55.506555

import 'dart:math' as math;

import 'package:flutter/material.dart';

class AlignCenterIcon extends StatelessWidget {
  final Color? color;
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: AlignCenterPainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
