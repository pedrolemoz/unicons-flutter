...
// Generated in 2024-08-26T20:39:59.521779

import 'dart:math' as math;

import 'package:flutter/material.dart';

class MouseAlt2Icon extends StatelessWidget {
  final Color? color;
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: MouseAlt2Painter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class MouseAlt2Painter extends CustomPainter {
  final Color color;

  const MouseAlt2Painter({
    super.repaint,
    required this.color,
  });
