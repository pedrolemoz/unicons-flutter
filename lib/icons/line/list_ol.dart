...
// Generated in 2024-08-26T20:39:59.109773

import 'dart:math' as math;

import 'package:flutter/material.dart';

class ListOlIcon extends StatelessWidget {
  final Color? color;
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: ListOlPainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class ListOlPainter extends CustomPainter {
  final Color color;
