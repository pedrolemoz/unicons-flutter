...
// Generated in 2024-08-26T20:39:56.967732

import 'dart:math' as math;

import 'package:flutter/material.dart';

class CommentAltPlusIcon extends StatelessWidget {
  final Color? color;

  const CommentAltPlusIcon({
    super.key,
    this.color,
  });
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: CommentAltPlusPainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class CommentAltPlusPainter extends CustomPainter {
  final Color color;

  const CommentAltPlusPainter({
    super.repaint,
    required this.color,
  });
