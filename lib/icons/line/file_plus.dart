...
// Generated in 2024-08-26T20:39:58.046656

import 'dart:math' as math;

import 'package:flutter/material.dart';

class FilePlusIcon extends StatelessWidget {
  final Color? color;
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: FilePlusPainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
