...
// Generated in 2024-08-26T20:39:55.790608

import 'dart:math' as math;

import 'package:flutter/material.dart';

class ArrowsHAltIcon extends StatelessWidget {
  final Color? color;
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: ArrowsHAltPainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class ArrowsHAltPainter extends CustomPainter {
  final Color color;
