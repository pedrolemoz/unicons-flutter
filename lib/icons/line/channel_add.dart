...
// Generated in 2024-08-26T20:39:56.411389

import 'dart:math' as math;

import 'package:flutter/material.dart';

class ChannelAddIcon extends StatelessWidget {
  final Color? color;

  const ChannelAddIcon({
    super.key,
    this.color,
  });
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: ChannelAddPainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class ChannelAddPainter extends CustomPainter {
  final Color color;

  const ChannelAddPainter({
    super.repaint,
    required this.color,
  });
