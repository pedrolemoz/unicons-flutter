...
// Generated in 2024-08-26T20:39:57.426292

import 'dart:math' as math;

import 'package:flutter/material.dart';

class DiceSixIcon extends StatelessWidget {
  final Color? color;
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: DiceSixPainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class DiceSixPainter extends CustomPainter {
  final Color color;

  const DiceSixPainter({
    super.repaint,
    required this.color,
  });
