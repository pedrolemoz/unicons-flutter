...
// Generated in 2024-08-26T20:39:58.868843

import 'dart:math' as math;

import 'package:flutter/material.dart';

class KeyholeCircleIcon extends StatelessWidget {
  final Color? color;

  const KeyholeCircleIcon({
    super.key,
    this.color,
  });
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: KeyholeCirclePainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class KeyholeCirclePainter extends CustomPainter {
  final Color color;
