...
// Generated in 2024-08-26T20:39:56.774513

import 'dart:math' as math;

import 'package:flutter/material.dart';

class CloudShowersIcon extends StatelessWidget {
  final Color? color;

  const CloudShowersIcon({
    super.key,
    this.color,
  });
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: CloudShowersPainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class CloudShowersPainter extends CustomPainter {
  final Color color;
