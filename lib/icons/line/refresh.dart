...
// Generated in 2024-08-26T20:40:00.085716
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: RefreshPainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class RefreshPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.cubicTo(
      ...
      10.343146131412551 * scale + translationY,
      13.656854643447833 * scale + translationX,
      9.000000430575467 * scale + translationY,
      12.000000417232513 * scale + translationX,
    ...
    path.cubicTo(
      9.000000430575469 * scale + translationX,
      13.656854643447833 * scale + translationY,
      10.343146131412553 * scale + translationX,
