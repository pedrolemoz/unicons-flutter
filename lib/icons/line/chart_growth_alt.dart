...
// Generated in 2024-08-26T20:39:56.439315

import 'dart:math' as math;

import 'package:flutter/material.dart';

class ChartGrowthAltIcon extends StatelessWidget {
  final Color? color;

  const ChartGrowthAltIcon({
    super.key,
    this.color,
  });
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: ChartGrowthAltPainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class ChartGrowthAltPainter extends CustomPainter {
  final Color color;

  const ChartGrowthAltPainter({
    super.repaint,
    required this.color,
  });
