...
// Generated in 2024-08-26T20:39:55.809560

import 'dart:math' as math;

import 'package:flutter/material.dart';

class ArrowsMergeIcon extends StatelessWidget {
  final Color? color;

  const ArrowsMergeIcon({
    super.key,
    this.color,
  });
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: ArrowsMergePainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class ArrowsMergePainter extends CustomPainter {
  final Color color;

  const ArrowsMergePainter({
    super.repaint,
    required this.color,
  });
