...
// Generated in 2024-08-26T20:39:56.896768

import 'dart:math' as math;

import 'package:flutter/material.dart';

class CommentAltChartLinesIcon extends StatelessWidget {
  final Color? color;
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: CommentAltChartLinesPainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class CommentAltChartLinesPainter extends CustomPainter {
  final Color color;

  const CommentAltChartLinesPainter({
    super.repaint,
    required this.color,
  });
