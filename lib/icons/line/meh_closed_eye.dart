...
// Generated in 2024-08-26T20:39:59.321366

import 'dart:math' as math;

import 'package:flutter/material.dart';

class MehClosedEyeIcon extends StatelessWidget {
  final Color? color;

  const MehClosedEyeIcon({
    super.key,
    this.color,
  });
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: MehClosedEyePainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class MehClosedEyePainter extends CustomPainter {
  final Color color;
