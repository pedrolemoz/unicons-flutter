...
// Generated in 2024-08-26T20:39:59.727700
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: PauseCirclePainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class PauseCirclePainter extends CustomPainter {
  final Color color;

  const PauseCirclePainter({
    super.repaint,
    required this.color,
  });
