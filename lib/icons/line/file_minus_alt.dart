...
// Generated in 2024-08-26T20:39:58.025310

import 'dart:math' as math;

import 'package:flutter/material.dart';

class FileMinusAltIcon extends StatelessWidget {
  final Color? color;

  const FileMinusAltIcon({
    super.key,
    this.color,
  });
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: FileMinusAltPainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class FileMinusAltPainter extends CustomPainter {
  final Color color;

  const FileMinusAltPainter({
    super.repaint,
    required this.color,
  });
