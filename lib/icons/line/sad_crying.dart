...
// Generated in 2024-08-26T20:40:00.177794

import 'dart:math' as math;

import 'package:flutter/material.dart';

class SadCryingIcon extends StatelessWidget {
  final Color? color;
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: SadCryingPainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class SadCryingPainter extends CustomPainter {
  final Color color;

  const SadCryingPainter({
    super.repaint,
    required this.color,
  });
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.cubicTo(
      11.224779148702886 * scale + translationX,
      15.84910924726731 * scale + translationY,
      12.77522023780019 * scale + translationX,
      15.84910924726731 * scale + translationY,
      13.999999642126795 * scale + translationX,
      16.609999575409002 * scale + translationY,
    );
    ...
    path.cubicTo(
      12.705916716511002 * scale + translationX,
      13.932472733414025 * scale + translationY,
      11.294083998744735 * scale + translationX,
      13.932472733414025 * scale + translationY,
