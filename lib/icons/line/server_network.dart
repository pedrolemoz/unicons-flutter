...
// Generated in 2024-08-26T20:40:00.293858

import 'dart:math' as math;

import 'package:flutter/material.dart';

class ServerNetworkIcon extends StatelessWidget {
  final Color? color;

  const ServerNetworkIcon({
    super.key,
    this.color,
  });
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: ServerNetworkPainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class ServerNetworkPainter extends CustomPainter {
  final Color color;

  const ServerNetworkPainter({
    super.repaint,
    required this.color,
  });
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.cubicTo(
      ...
      9.259945643307432 * scale + translationY,
      19.717789722967876 * scale + translationX,
      8.547637259963121 * scale + translationY,
    ...
    path.cubicTo(
      19.717789722967876 * scale + translationX,
      7.452363216874036 * scale + translationY,
    ...
    path.cubicTo(
      ...
      6.740054833529728 * scale + translationY,
    ...
    path.cubicTo(
      ...
      8.547637259963121 * scale + translationY,
      4.004410722783581 * scale + translationX,
      9.25994564330743 * scale + translationY,
      4.0000001192092896 * scale + translationX,
