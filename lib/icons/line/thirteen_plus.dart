...
// Generated in 2024-08-26T20:39:55.390359

import 'dart:math' as math;

import 'package:flutter/material.dart';

class ThriteenPlusIcon extends StatelessWidget {
  final Color? color;

  const ThriteenPlusIcon({
    super.key,
    this.color,
  });
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: ThriteenPlusPainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class ThriteenPlusPainter extends CustomPainter {
  final Color color;

  const ThriteenPlusPainter({
    super.repaint,
    required this.color,
  });
