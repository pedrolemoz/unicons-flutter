...
// Generated in 2024-08-26T20:39:57.897353

import 'dart:math' as math;

import 'package:flutter/material.dart';

class FileBlankIcon extends StatelessWidget {
  final Color? color;
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: FileBlankPainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class FileBlankPainter extends CustomPainter {
  final Color color;
