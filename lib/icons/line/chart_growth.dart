...
// Generated in 2024-08-26T20:39:56.445338

import 'dart:math' as math;

import 'package:flutter/material.dart';

class ChartGrowthIcon extends StatelessWidget {
  final Color? color;

  const ChartGrowthIcon({
    super.key,
    this.color,
  });
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: ChartGrowthPainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class ChartGrowthPainter extends CustomPainter {
  final Color color;
