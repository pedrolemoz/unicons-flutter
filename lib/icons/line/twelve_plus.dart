...
// Generated in 2024-08-26T20:39:55.385400

import 'dart:math' as math;

import 'package:flutter/material.dart';

class TwelvePlusIcon extends StatelessWidget {
  final Color? color;

  const TwelvePlusIcon({
    super.key,
    this.color,
  });
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: TwelvePlusPainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class TwelvePlusPainter extends CustomPainter {
  final Color color;

  const TwelvePlusPainter({
    super.repaint,
    required this.color,
  });
