...
// Generated in 2024-08-26T20:39:59.789660
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: PhonePainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class PhonePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.cubicTo(
      19.374681651634504 * scale + translationX,
      19.946199186047927 * scale + translationY,
      19.076452003905917 * scale + translationX,
      20.03712285913591 * scale + translationY,
      18.779999203111444 * scale + translationX,
      19.99999915134339 * scale + translationY,
    );
