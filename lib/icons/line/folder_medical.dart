...
// Generated in 2024-08-26T20:39:58.229937

import 'dart:math' as math;

import 'package:flutter/material.dart';

class FolderMedicalIcon extends StatelessWidget {
  final Color? color;

  const FolderMedicalIcon({
    super.key,
    this.color,
  });
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: FolderMedicalPainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class FolderMedicalPainter extends CustomPainter {
  final Color color;

  const FolderMedicalPainter({
    super.repaint,
    required this.color,
  });
