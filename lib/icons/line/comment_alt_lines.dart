...
// Generated in 2024-08-26T20:39:56.942436

import 'dart:math' as math;

import 'package:flutter/material.dart';

class CommentAltLinesIcon extends StatelessWidget {
  final Color? color;

  const CommentAltLinesIcon({
    super.key,
    this.color,
  });
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: CommentAltLinesPainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class CommentAltLinesPainter extends CustomPainter {
  final Color color;

  const CommentAltLinesPainter({
    super.repaint,
    required this.color,
  });
