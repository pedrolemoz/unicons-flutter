...
// Generated in 2024-08-26T20:39:56.234258

import 'dart:math' as math;

import 'package:flutter/material.dart';

class BrightnessMinusIcon extends StatelessWidget {
  final Color? color;

  const BrightnessMinusIcon({
    super.key,
    this.color,
  });
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: BrightnessMinusPainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class BrightnessMinusPainter extends CustomPainter {
  final Color color;

  const BrightnessMinusPainter({
    super.repaint,
    required this.color,
  });
