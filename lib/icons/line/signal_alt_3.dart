...
// Generated in 2024-08-26T20:40:00.454530

import 'dart:math' as math;

import 'package:flutter/material.dart';

class SignalAlt3Icon extends StatelessWidget {
  final Color? color;

  const SignalAlt3Icon({
    super.key,
    this.color,
  });
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: SignalAlt3Painter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class SignalAlt3Painter extends CustomPainter {
  final Color color;

  const SignalAlt3Painter({
    super.repaint,
    required this.color,
  });
