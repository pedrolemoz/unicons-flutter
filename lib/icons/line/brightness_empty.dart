...
// Generated in 2024-08-26T20:39:56.219298

import 'dart:math' as math;

import 'package:flutter/material.dart';

class BrightnessEmptyIcon extends StatelessWidget {
  final Color? color;

  const BrightnessEmptyIcon({
    super.key,
    this.color,
  });
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: BrightnessEmptyPainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class BrightnessEmptyPainter extends CustomPainter {
  final Color color;
