...
// Generated in 2024-08-26T20:39:59.362626
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: MinusCirclePainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class MinusCirclePainter extends CustomPainter {
  final Color color;

  const MinusCirclePainter({
    super.repaint,
    required this.color,
  });
