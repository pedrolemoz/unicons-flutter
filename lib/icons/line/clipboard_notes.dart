...
// Generated in 2024-08-26T20:39:56.555896

import 'dart:math' as math;

import 'package:flutter/material.dart';

class ClipboardNotesIcon extends StatelessWidget {
  final Color? color;

  const ClipboardNotesIcon({
    super.key,
    this.color,
  });
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: ClipboardNotesPainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class ClipboardNotesPainter extends CustomPainter {
  final Color color;

  const ClipboardNotesPainter({
    super.repaint,
    required this.color,
  });
