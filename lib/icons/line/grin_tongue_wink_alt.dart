...
// Generated in 2024-08-26T20:39:58.432262

import 'dart:math' as math;

import 'package:flutter/material.dart';

class GrinTongueWinkAltIcon extends StatelessWidget {
  final Color? color;

  const GrinTongueWinkAltIcon({
    super.key,
    this.color,
  });
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: GrinTongueWinkAltPainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class GrinTongueWinkAltPainter extends CustomPainter {
  final Color color;

  const GrinTongueWinkAltPainter({
    super.repaint,
    required this.color,
  });
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.cubicTo(
      ...
      16.656854696527216 * scale + translationY,
      10.343146108135489 * scale + translationX,
      18.000000447034836 * scale + translationY,
