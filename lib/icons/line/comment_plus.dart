...
// Generated in 2024-08-26T20:39:57.096994

import 'dart:math' as math;

import 'package:flutter/material.dart';

class CommentPlusIcon extends StatelessWidget {
  final Color? color;

  const CommentPlusIcon({
    super.key,
    this.color,
  });
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: CommentPlusPainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class CommentPlusPainter extends CustomPainter {
  final Color color;

  const CommentPlusPainter({
    super.repaint,
    required this.color,
  });
