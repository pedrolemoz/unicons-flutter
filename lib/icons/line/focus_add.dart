...
// Generated in 2024-08-26T20:39:58.184007

import 'dart:math' as math;

import 'package:flutter/material.dart';

class FocusAddIcon extends StatelessWidget {
  final Color? color;
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: FocusAddPainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class FocusAddPainter extends CustomPainter {
  final Color color;

  const FocusAddPainter({
    super.repaint,
    required this.color,
  });
