...
// Generated in 2024-08-26T20:39:57.082646

import 'dart:math' as math;

import 'package:flutter/material.dart';

class CommentMedicalIcon extends StatelessWidget {
  final Color? color;

  const CommentMedicalIcon({
    super.key,
    this.color,
  });
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: CommentMedicalPainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class CommentMedicalPainter extends CustomPainter {
  final Color color;

  const CommentMedicalPainter({
    super.repaint,
    required this.color,
  });
