...
// Generated in 2024-08-26T20:39:57.034279

import 'dart:math' as math;

import 'package:flutter/material.dart';

class CommentDotsIcon extends StatelessWidget {
  final Color? color;
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: CommentDotsPainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class CommentDotsPainter extends CustomPainter {
  final Color color;
