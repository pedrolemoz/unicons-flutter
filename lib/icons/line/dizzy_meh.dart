...
// Generated in 2024-08-26T20:39:57.455244

import 'dart:math' as math;

import 'package:flutter/material.dart';

class DizzyMehIcon extends StatelessWidget {
  final Color? color;
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: DizzyMehPainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class DizzyMehPainter extends CustomPainter {
  final Color color;
