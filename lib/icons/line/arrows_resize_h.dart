...
// Generated in 2024-08-26T20:39:55.814547

import 'dart:math' as math;

import 'package:flutter/material.dart';

class ArrowsResizeHIcon extends StatelessWidget {
  final Color? color;

  const ArrowsResizeHIcon({
    super.key,
    this.color,
  });
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: ArrowsResizeHPainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class ArrowsResizeHPainter extends CustomPainter {
  final Color color;

  const ArrowsResizeHPainter({
    super.repaint,
    required this.color,
  });
