...
// Generated in 2024-08-26T20:39:59.316379

import 'dart:math' as math;

import 'package:flutter/material.dart';

class MehAltIcon extends StatelessWidget {
  final Color? color;
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: MehAltPainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class MehAltPainter extends CustomPainter {
  final Color color;
