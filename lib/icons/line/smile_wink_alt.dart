...
// Generated in 2024-08-26T20:40:00.571912

import 'dart:math' as math;

import 'package:flutter/material.dart';

class SmileWinkAltIcon extends StatelessWidget {
  final Color? color;

  const SmileWinkAltIcon({
    super.key,
    this.color,
  });
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: SmileWinkAltPainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class SmileWinkAltPainter extends CustomPainter {
  final Color color;

  const SmileWinkAltPainter({
    super.repaint,
    required this.color,
  });
