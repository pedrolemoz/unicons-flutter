...
// Generated in 2024-08-26T20:39:57.068179

import 'dart:math' as math;

import 'package:flutter/material.dart';

class CommentInfoIcon extends StatelessWidget {
  final Color? color;

  const CommentInfoIcon({
    super.key,
    this.color,
  });
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: CommentInfoPainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class CommentInfoPainter extends CustomPainter {
  final Color color;
