...
// Generated in 2024-08-26T20:40:00.476151

import 'dart:math' as math;

import 'package:flutter/material.dart';

class SilenceIcon extends StatelessWidget {
  final Color? color;
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: SilencePainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class SilencePainter extends CustomPainter {
  final Color color;

  const SilencePainter({
    super.repaint,
    required this.color,
  });
