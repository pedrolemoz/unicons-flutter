...
// Generated in 2024-08-26T20:39:56.719503

import 'dart:math' as math;

import 'package:flutter/material.dart';

class CloudMoonShowersIcon extends StatelessWidget {
  final Color? color;

  const CloudMoonShowersIcon({
    super.key,
    this.color,
  });
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: CloudMoonShowersPainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class CloudMoonShowersPainter extends CustomPainter {
  final Color color;
