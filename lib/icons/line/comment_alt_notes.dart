...
// Generated in 2024-08-26T20:39:56.962746

import 'dart:math' as math;

import 'package:flutter/material.dart';

class CommentAltNotesIcon extends StatelessWidget {
  final Color? color;
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: CommentAltNotesPainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class CommentAltNotesPainter extends CustomPainter {
  final Color color;
