...
// Generated in 2024-08-26T20:39:57.998387

import 'dart:math' as math;

import 'package:flutter/material.dart';

class FileLandscapeIcon extends StatelessWidget {
  final Color? color;
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: FileLandscapePainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class FileLandscapePainter extends CustomPainter {
  final Color color;
