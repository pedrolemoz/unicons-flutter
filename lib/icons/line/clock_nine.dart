...
// Generated in 2024-08-26T20:39:56.578463

import 'dart:math' as math;

import 'package:flutter/material.dart';

class ClockNineIcon extends StatelessWidget {
  final Color? color;
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: ClockNinePainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class ClockNinePainter extends CustomPainter {
  final Color color;

  const ClockNinePainter({
    super.repaint,
    required this.color,
  });
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.cubicTo(
      ...
      13.000144362095627 * scale + translationY,
      13.000144362095625 * scale + translationX,
      12.552344905324798 * scale + translationY,
      13.00000067054853 * scale + translationX,
      12.000000618967874 * scale + translationY,
    );
