...
// Generated in 2024-08-26T20:39:55.407314

import 'dart:math' as math;

import 'package:flutter/material.dart';

class EighteenPlusIcon extends StatelessWidget {
  final Color? color;
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: EighteenPlusPainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class EighteenPlusPainter extends CustomPainter {
  final Color color;

  const EighteenPlusPainter({
    super.repaint,
    required this.color,
  });
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.cubicTo(
      11.004410931399836 * scale + translationX,
      10.740054952739017 * scale + translationY,
      11.282211200904115 * scale + translationX,
      11.452363336083327 * scale + translationY,
      11.780000351071356 * scale + translationX,
      12.000000357627869 * scale + translationY,
    );

    path.cubicTo(
      11.282211200904117 * scale + translationX,
    ...
    path.cubicTo(
      11.000000278447441 * scale + translationX,
    ...
    path.cubicTo(
      17.99558993286751 * scale + translationX,
      13.259945762516722 * scale + translationY,
      17.71778966336323 * scale + translationX,
      12.54763737917241 * scale + translationY,
      17.22000051319599 * scale + translationX,
      12.000000357627869 * scale + translationY,
    );
    ...
    path.cubicTo(
      17.71778966336323 * scale + translationX,
      11.452363336083327 * scale + translationY,
      17.995589932867514 * scale + translationX,
      10.740054952739017 * scale + translationY,
      18.000000536441803 * scale + translationX,
    ...
    path.cubicTo(
      ...
      11.000000278447441 * scale + translationX,
      7.343145948897336 * scale + translationY,
      11.000000327825548 * scale + translationX,
