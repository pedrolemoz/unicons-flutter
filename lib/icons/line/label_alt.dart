...
// Generated in 2024-08-26T20:39:58.889787

import 'dart:math' as math;

import 'package:flutter/material.dart';

class LabelAltIcon extends StatelessWidget {
  final Color? color;
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: LabelAltPainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class LabelAltPainter extends CustomPainter {
  final Color color;
