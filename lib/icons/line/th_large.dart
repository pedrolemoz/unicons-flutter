...
// Generated in 2024-08-26T20:40:00.977431

import 'dart:math' as math;

import 'package:flutter/material.dart';

class ThLargeIcon extends StatelessWidget {
  final Color? color;
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: ThLargePainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class ThLargePainter extends CustomPainter {
  final Color color;

  const ThLargePainter({
    super.repaint,
    required this.color,
  });
