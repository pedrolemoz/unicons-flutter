...
// Generated in 2024-08-26T20:39:59.712231

import 'dart:math' as math;

import 'package:flutter/material.dart';

class ParkingSquareIcon extends StatelessWidget {
  final Color? color;
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: ParkingSquarePainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class ParkingSquarePainter extends CustomPainter {
  final Color color;

  const ParkingSquarePainter({
    super.repaint,
    required this.color,
  });
