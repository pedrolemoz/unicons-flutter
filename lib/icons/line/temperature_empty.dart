...
// Generated in 2024-08-26T20:40:00.915285

import 'dart:math' as math;

import 'package:flutter/material.dart';

class TemperatureEmptyIcon extends StatelessWidget {
  final Color? color;

  const TemperatureEmptyIcon({
    super.key,
    this.color,
  });
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: TemperatureEmptyPainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class TemperatureEmptyPainter extends CustomPainter {
  final Color color;

  const TemperatureEmptyPainter({
    super.repaint,
    required this.color,
  });
