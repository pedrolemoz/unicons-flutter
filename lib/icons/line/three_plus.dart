...
// Generated in 2024-08-26T20:39:55.417287

import 'dart:math' as math;

import 'package:flutter/material.dart';

class ThreePlusIcon extends StatelessWidget {
  final Color? color;
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: ThreePlusPainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class ThreePlusPainter extends CustomPainter {
  final Color color;

  const ThreePlusPainter({
    super.repaint,
    required this.color,
  });
