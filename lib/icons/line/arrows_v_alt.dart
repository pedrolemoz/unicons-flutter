...
// Generated in 2024-08-26T20:39:55.849353

import 'dart:math' as math;

import 'package:flutter/material.dart';

class ArrowsVAltIcon extends StatelessWidget {
  final Color? color;

  const ArrowsVAltIcon({
    super.key,
    this.color,
  });
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: ArrowsVAltPainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class ArrowsVAltPainter extends CustomPainter {
  final Color color;

  const ArrowsVAltPainter({
    super.repaint,
    required this.color,
  });
