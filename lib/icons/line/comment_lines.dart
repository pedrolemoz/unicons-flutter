...
// Generated in 2024-08-26T20:39:57.072673

import 'dart:math' as math;

import 'package:flutter/material.dart';

class CommentLinesIcon extends StatelessWidget {
  final Color? color;
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: CommentLinesPainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class CommentLinesPainter extends CustomPainter {
  final Color color;
