...
// Generated in 2024-08-26T20:40:00.941821

import 'dart:math' as math;

import 'package:flutter/material.dart';

class TemperatureThreeQuarterIcon extends StatelessWidget {
  final Color? color;

  const TemperatureThreeQuarterIcon({
    super.key,
    this.color,
  });
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: TemperatureThreeQuarterPainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class TemperatureThreeQuarterPainter extends CustomPainter {
  final Color color;

  const TemperatureThreeQuarterPainter({
    super.repaint,
    required this.color,
  });
