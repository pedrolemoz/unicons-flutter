...
// Generated in 2024-08-26T20:39:58.020299

import 'dart:math' as math;

import 'package:flutter/material.dart';

class FileMedicalIcon extends StatelessWidget {
  final Color? color;

  const FileMedicalIcon({
    super.key,
    this.color,
  });
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: FileMedicalPainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class FileMedicalPainter extends CustomPainter {
  final Color color;

  const FileMedicalPainter({
    super.repaint,
    required this.color,
  });
