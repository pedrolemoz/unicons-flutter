...
// Generated in 2024-08-26T20:39:57.494771

import 'dart:math' as math;

import 'package:flutter/material.dart';

class DollarSignAltIcon extends StatelessWidget {
  final Color? color;

  const DollarSignAltIcon({
    super.key,
    this.color,
  });
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: DollarSignAltPainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class DollarSignAltPainter extends CustomPainter {
  final Color color;

  const DollarSignAltPainter({
    super.repaint,
    required this.color,
  });
