...
// Generated in 2024-08-26T20:40:00.731318
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: StopCirclePainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class StopCirclePainter extends CustomPainter {
  final Color color;

  const StopCirclePainter({
    super.repaint,
    required this.color,
  });
