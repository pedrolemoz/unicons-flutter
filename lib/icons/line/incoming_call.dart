...
// Generated in 2024-08-26T20:39:58.768413
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: IncomingCallPainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class IncomingCallPainter extends CustomPainter {
  final Color color;

  const IncomingCallPainter({
    super.repaint,
    required this.color,
  });
