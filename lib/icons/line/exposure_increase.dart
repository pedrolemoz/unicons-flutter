...
// Generated in 2024-08-26T20:39:57.817255

import 'dart:math' as math;

import 'package:flutter/material.dart';

class ExposureIncreaseIcon extends StatelessWidget {
  final Color? color;

  const ExposureIncreaseIcon({
    super.key,
    this.color,
  });
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: ExposureIncreasePainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class ExposureIncreasePainter extends CustomPainter {
  final Color color;
