...
// Generated in 2024-08-26T20:40:00.258677

import 'dart:math' as math;

import 'package:flutter/material.dart';

class SearchPlusIcon extends StatelessWidget {
  final Color? color;
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: SearchPlusPainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class SearchPlusPainter extends CustomPainter {
  final Color color;

  const SearchPlusPainter({
    super.repaint,
    required this.color,
  });
