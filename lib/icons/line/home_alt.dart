...
// Generated in 2024-08-26T20:39:58.543520

import 'dart:math' as math;

import 'package:flutter/material.dart';

class HomeAltIcon extends StatelessWidget {
  final Color? color;
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: HomeAltPainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class HomeAltPainter extends CustomPainter {
  final Color color;

  const HomeAltPainter({
    super.repaint,
    required this.color,
  });
