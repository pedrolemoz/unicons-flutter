...
// Generated in 2024-08-26T20:40:00.937103

import 'dart:math' as math;

import 'package:flutter/material.dart';

class TemperatureQuarterIcon extends StatelessWidget {
  final Color? color;

  const TemperatureQuarterIcon({
    super.key,
    this.color,
  });
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: TemperatureQuarterPainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class TemperatureQuarterPainter extends CustomPainter {
  final Color color;

  const TemperatureQuarterPainter({
    super.repaint,
    required this.color,
  });
