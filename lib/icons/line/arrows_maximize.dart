...
// Generated in 2024-08-26T20:39:55.805571

import 'dart:math' as math;

import 'package:flutter/material.dart';

class ArrowsMaximizeIcon extends StatelessWidget {
  final Color? color;

  const ArrowsMaximizeIcon({
    super.key,
    this.color,
  });
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: ArrowsMaximizePainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class ArrowsMaximizePainter extends CustomPainter {
  final Color color;

  const ArrowsMaximizePainter({
    super.repaint,
    required this.color,
  });
