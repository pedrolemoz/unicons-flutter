...
// Generated in 2024-08-26T20:39:57.417315

import 'dart:math' as math;

import 'package:flutter/material.dart';

class DiceFourIcon extends StatelessWidget {
  final Color? color;
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: DiceFourPainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class DiceFourPainter extends CustomPainter {
  final Color color;
