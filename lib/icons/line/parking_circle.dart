...
// Generated in 2024-08-26T20:39:59.707245

import 'dart:math' as math;

import 'package:flutter/material.dart';

class ParkingCircleIcon extends StatelessWidget {
  final Color? color;
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: ParkingCirclePainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class ParkingCirclePainter extends CustomPainter {
  final Color color;

  const ParkingCirclePainter({
    super.repaint,
    required this.color,
  });
