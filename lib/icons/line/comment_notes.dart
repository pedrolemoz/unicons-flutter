...
// Generated in 2024-08-26T20:39:57.091622

import 'dart:math' as math;

import 'package:flutter/material.dart';

class CommentNotesIcon extends StatelessWidget {
  final Color? color;

  const CommentNotesIcon({
    super.key,
    this.color,
  });
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: CommentNotesPainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class CommentNotesPainter extends CustomPainter {
  final Color color;
