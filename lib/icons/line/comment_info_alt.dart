...
// Generated in 2024-08-26T20:39:57.063192

import 'dart:math' as math;

import 'package:flutter/material.dart';

class CommentInfoAltIcon extends StatelessWidget {
  final Color? color;

  const CommentInfoAltIcon({
    super.key,
    this.color,
  });
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: CommentInfoAltPainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class CommentInfoAltPainter extends CustomPainter {
  final Color color;
