...
// Generated in 2024-08-26T20:39:56.922699

import 'dart:math' as math;

import 'package:flutter/material.dart';

class CommentAltExclamationIcon extends StatelessWidget {
  final Color? color;
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: CommentAltExclamationPainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class CommentAltExclamationPainter extends CustomPainter {
  final Color color;

  const CommentAltExclamationPainter({
    super.repaint,
    required this.color,
  });
