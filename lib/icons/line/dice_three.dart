...
// Generated in 2024-08-26T20:39:57.431278

import 'dart:math' as math;

import 'package:flutter/material.dart';

class DiceThreeIcon extends StatelessWidget {
  final Color? color;
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: DiceThreePainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class DiceThreePainter extends CustomPainter {
  final Color color;

  const DiceThreePainter({
    super.repaint,
    required this.color,
  });
