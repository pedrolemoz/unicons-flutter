...
// Generated in 2024-08-26T20:39:56.674087

import 'dart:math' as math;

import 'package:flutter/material.dart';

class CloudHailIcon extends StatelessWidget {
  final Color? color;
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: CloudHailPainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class CloudHailPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final scaleY = size.height / 19.358509799081297;
    final scale = math.min(scaleX, scaleY);

    final translationX = (size.width - 20.255727792493488 * scale) / 2 - 1.9963882838175966 * scale;
    final translationY = (size.height - 19.358509799081297 * scale) / 2 - 1.6414902009187042 * scale;
