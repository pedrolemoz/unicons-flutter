...
// Generated in 2024-08-26T20:40:01.107327

import 'dart:math' as math;

import 'package:flutter/material.dart';

class TrashAltIcon extends StatelessWidget {
  final Color? color;
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: TrashAltPainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class TrashAltPainter extends CustomPainter {
  final Color color;

  const TrashAltPainter({
    super.repaint,
    required this.color,
  });
