...
// Generated in 2024-08-26T20:39:57.412329

import 'dart:math' as math;

import 'package:flutter/material.dart';

class DiceFiveIcon extends StatelessWidget {
  final Color? color;
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: DiceFivePainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class DiceFivePainter extends CustomPainter {
  final Color color;
