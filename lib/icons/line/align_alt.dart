...
// Generated in 2024-08-26T20:39:55.481647

import 'dart:math' as math;

import 'package:flutter/material.dart';

class AlignAltIcon extends StatelessWidget {
  final Color? color;
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: AlignAltPainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class AlignAltPainter extends CustomPainter {
  final Color color;

  const AlignAltPainter({
    super.repaint,
    required this.color,
  });
