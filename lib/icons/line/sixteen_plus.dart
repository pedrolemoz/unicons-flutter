...
// Generated in 2024-08-26T20:39:55.396343

import 'dart:math' as math;

import 'package:flutter/material.dart';

class SixteenPlusIcon extends StatelessWidget {
  final Color? color;
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: SixteenPlusPainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class SixteenPlusPainter extends CustomPainter {
  final Color color;

  const SixteenPlusPainter({
    super.repaint,
    required this.color,
  });
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.cubicTo(
      18.000000585819908 * scale + translationX,
