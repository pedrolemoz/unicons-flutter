...
// Generated in 2024-08-26T20:39:55.380387

import 'dart:math' as math;

import 'package:flutter/material.dart';

class TenPlusIcon extends StatelessWidget {
  final Color? color;
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: TenPlusPainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class TenPlusPainter extends CustomPainter {
  final Color color;
