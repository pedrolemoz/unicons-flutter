...
// Generated in 2024-08-26T20:39:56.957553

import 'dart:math' as math;

import 'package:flutter/material.dart';

class CommentAltMessageIcon extends StatelessWidget {
  final Color? color;

  const CommentAltMessageIcon({
    super.key,
    this.color,
  });
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: CommentAltMessagePainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class CommentAltMessagePainter extends CustomPainter {
  final Color color;

  const CommentAltMessagePainter({
    super.repaint,
    required this.color,
  });
