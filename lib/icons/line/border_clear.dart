...
// Generated in 2024-08-26T20:39:56.141504

import 'dart:math' as math;

import 'package:flutter/material.dart';

class BorderClearIcon extends StatelessWidget {
  final Color? color;

  const BorderClearIcon({
    super.key,
    this.color,
  });
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: BorderClearPainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class BorderClearPainter extends CustomPainter {
  final Color color;

  const BorderClearPainter({
    super.repaint,
    required this.color,
  });
