...
// Generated in 2024-08-26T20:39:56.224286

import 'dart:math' as math;

import 'package:flutter/material.dart';

class BrightnessHalfIcon extends StatelessWidget {
  final Color? color;

  const BrightnessHalfIcon({
    super.key,
    this.color,
  });
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: BrightnessHalfPainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class BrightnessHalfPainter extends CustomPainter {
  final Color color;

  const BrightnessHalfPainter({
    super.repaint,
    required this.color,
  });
