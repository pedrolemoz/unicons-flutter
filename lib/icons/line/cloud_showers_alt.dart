...
// Generated in 2024-08-26T20:39:56.763164

import 'dart:math' as math;

import 'package:flutter/material.dart';

class CloudShowersAltIcon extends StatelessWidget {
  final Color? color;

  const CloudShowersAltIcon({
    super.key,
    this.color,
  });
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return CustomPaint(
          size: size,
          painter: CloudShowersAltPainter(color: color ?? colorScheme.primary),
        );
      },
    );
  }
...
class CloudShowersAltPainter extends CustomPainter {
  final Color color;

  const CloudShowersAltPainter({
    super.repaint,
    required this.color,
  });
